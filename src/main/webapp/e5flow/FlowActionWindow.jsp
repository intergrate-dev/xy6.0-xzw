		...
		var defaulticon = "../images/empty.gif";
			...
			$(function () {
				...
				$("#flowform").validationEngine({
					...
					onValidationComplete:function(from,r){
						...
						var nodeData = {
							...
							window.parent.e5ActionWindowClose(nodeData);
							issubmit = true;
						//end
						}
						else{
				...
				$("#btnActionCancle").click(function(){
					window.parent.e5ActionWindowClose(null);
				});
				$.ajax({
					...
					success:function(data) {
						if(data!=null){
							...
							//
							$.ajax({
								url:"../e5listpage/cust_iconViewReader.do",dataType:"json", 
		...
		<form name="flowform" id="flowform" method="post" action="">
			<div id="nodewindows" class="nodewindows-flow">
				<table class="table" cellpadding="0" cellspacing="0">
					<tr>
						<td style="width:100px;"><span class="field-required">*</span><i18n:message key="flow.visual.node.window.doname"/>:</td>
						<td style="width:480px;"><input class="validate[required,custom[onlyCharNumberChiness],maxSize[40]]" type="text" id="txtDoName" />
