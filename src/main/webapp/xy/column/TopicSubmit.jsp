	...
	<script type="text/javascript">
		function doClose() {
			...
			if (error) {
				...
				if(isBat == "true"){
					var tool = parent.parent.frames["frmColLeft"].topic_tree;
				...
				if (isNew == "true"&& isBat!="true") {
					...
					if (name) {
						var tool = parent.parent.parent.frames["frmColLeft"].topic_tree;
						tool.treeUpdate(colID, name);
					}
					parent.topic_form.refresh();
					//修改不太容易看出来变化，因此加提示
					alert("操作完成。");
				}
			}
