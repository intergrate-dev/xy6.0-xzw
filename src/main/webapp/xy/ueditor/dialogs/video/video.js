...
(function () {
    ...
    function initVideo() {
        ...
        (function () {
            ...
            if (img && img.className) {
                var hasFakedClass = (img.className == "edui-faked-video" || img.className.indexOf("edui-faked-audio")!=-1),
    ...
    function insertSingle() {
        ...
        var usePlayer = parseInt($("input:radio[name='usePlayer']:checked").val());
        if (usePlayer&&isAudio()) {
            ...
            editor.execCommand('insertonlinevideo', {
                url: convert_url(url),
                width: width.value,
                height: height.value,
                align: align
    ...
    function isAudio() {
        ...
        return extension==="mp3" || extension==="ogg"|| extension==="wma"|| extension==="wav";
    }
    ...
    /* 插入上传视频 */
    function insertVideoLib() {
        editor.execCommand('insertvideolib', onlineImage.getInsertList(), 'videolib');
        /*
         var videoObjs=[],
         uploadDir = editor.getOpt('videoUrlPrefix'),
         width = $G('upload_width').value || 420,
    ...
    OnlineImage.prototype = {
        init: function () {
			//编辑器的“插入视频”是单独的对话框，取父的siteID
			var siteID = parent.article.siteID;
			var url = "../../../GroupSelect.do?type=1&editor=1&siteID=" + siteID;
       ...
       getInsertList: function () {
			...
			//取子窗口中选中的视频
			var param = $("#videoFrame")[0].contentWindow.toolbarparam;
			...
			$.ajax({ url: "../../../video/Info.do", async: false,
				...
				success: function (data) {
					...
					var videoInfo = {
						//src: "../../xy/image.do?path=" + $img.attr("src"),
						//_src: $img.attr("_src"),
						videoID: videoID,
						DocLibID: docLibID,
						DocID: docID,
