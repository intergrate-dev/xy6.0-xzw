    ...
    <div role="tabpanel" class="tab-pane active" id="customImage">
        <div id="mainDiv" class="container-fluid">
            ...
            <div class="row">
                ...
                <div id="previewImgDiv" style="float: left;">
                    <c:if test='${ itype=="all" || itype=="small"}'>
                        <div class="row" >
                            <div class="preview-word" style="top: 214px;">小
                                ...
                                <span id="preview-word-assign_small" class="preview-word-assign">
                                    ...
                                    <span style="position: absolute; left: 40px;top: 3px;margin: 0px 0px 0px 15px;">×</span>
                            ...
                            <div id="preview-pane-small" itype="small" class="preview-pane" style="top: 242px; " onclick="chooseCropImage('small')">
                    ...
                    <c:if test='${itype=="all" || itype=="big" }'>
                        <div class="row">
                            <div class="preview-word" style="top:47px; ">大
                                ...
                                <span id="preview-word-assign_big" class="preview-word-assign" style="">
                                    ...
                                    <span class="preview-pane-span-first">px</span>
                                    <span style="position: absolute;left: 54px;top: 3px;margin: 0px 0px 0px 15px;">×</span>
                            ...
                            <div id="preview-pane-big" itype="big"  class="preview-pane"  style="top: 72px; display: block" onclick="chooseCropImage('big')">
            ...
            <div class="row" style="text-align: right;">
                <input class="btn btn-default btngroup" type="button" id="useOrignalBtn" value="使用原图" onclick="useOrignalImg()" style="margin: 10px;width: 80px;" disabled="disabled" />
