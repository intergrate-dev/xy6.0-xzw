...
var article_sensitive = {
    ...
    senList: [],
    illList: [],
    hasSensitive: function(sContent){//type: 写稿-0;  评论-1
        var bResult = false;
        $.ajax({
            async: false,
    ...
    /*handleSensitive: function(){
        ...
        for(var _i = 0, _size = article_sensitive.senList.length; _i < _size; _i++){
            var _sen = article_sensitive.escape(article_sensitive.senList[_i]);
    ...
    cleanSenStyle: function(){
        ...
        var content = editor.getContent();
        //把敏感词替换
        for(var _i = article_sensitive.senList.length - 1; _i >= 0; _i--){
            var _sen =article_sensitive.escape(article_sensitive.senList[_i]);
    ...
    handleIllegal: function(){
        ...
        for(var _i = 0, _size = article_sensitive.illList.length; _i < _size; _i++){
            var _ill = article_sensitive.escape(article_sensitive.illList[_i]);
    ...
    cleanIllStyle: function(){
        ...
        var content = editor.getContent();
        //把非法词替换
        for(var _i = article_sensitive.illList.length - 1; _i >= 0; _i--){
            var _ill =article_sensitive.escape(article_sensitive.illList[_i]);
