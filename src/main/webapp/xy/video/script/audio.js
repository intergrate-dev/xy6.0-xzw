...
var video_form = {
    ...
    init : function() {
        ...
        $("#audioSelect").click(video_form.videoSelect);
    ...
    videoSelect : function(){
        var url = "../../xy/video/Add.do?isAudio=1";
...
/*        $.ajax({
    ...
    initUploadPlugin: function(){
        ...
        var uploader = WebUploader.create({
            ...
            accept :{
                //mimeTypes: 'audio/*'
                mimeTypes: 'audio/x-wav,audio/x-pn-real,audio-plugin,audio/x-ms-wma,audio/x-mpeg,audio/x-mpegurl,audio/mpeg'
            },
            auto: false,
        ...
        uploader.on('uploadComplete', function(file){
            ...
            nowFile = file;
            $("#v_path").val(video_form.videoPath + Slash + file.name);
        ...
        $.ajax({
            ...
            success: function(data){
                if(data.code == 0){
                    ...
                    video_form.realTranPath = data.realTranPath;
...
function uploadClose(sessionID){
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#v_transPath").val(data.path.substring(0,data.path.lastIndexOf(".")));
