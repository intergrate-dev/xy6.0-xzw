...
//
                    writeStyle(styleName, txt,".nav-pills > li:not(.active):not(:hover) > a",".nav-pills li ul.dropdown-menu li a:not(:hover)");
//
                    ...
                    writeStyle(styleName, txt,".nav-pills > li > a:hover",".nav-pills li ul.dropdown-menu li a:hover");
                    //changeMainStyle(".nav-pills > li > a:hover", styleName, txt);
                } else if ($styleClick.hasClass("activt")) {
                    dataBox.attr("data-2", txt);
                    writeStyle(styleName, txt,".nav-pills > li.active > a",".nav-pills li ul.dropdown-menu li a:focus");
        ...
        function writeStyle(styleName, txt,mainSelector,subSelector){
            var partSelectorVal="";
            ...
            $headColorPickStyle.spectrum(
                LEColorPicker.getOptions(function (tinycolor) {
                    ...
                    if ($styleNormal.hasClass("activt")) {
                        ...
                        writeStyle(styleName, _c,".nav-pills > li:not(.active):not(:hover) > a",".nav-pills li ul.dropdown-menu li a:not(:hover)");
                       // changeMainStyle(".nav-pills > li:not(.active):not(:hover) > a", "color", _c);
                    } else if ($styleHover.hasClass("activt")) {
                        $headColorPickStyle.attr("data-1", _c);
                        writeStyle(styleName, _c,".nav-pills > li > a:hover",".nav-pills li ul.dropdown-menu li a:hover");
                       // changeMainStyle(".nav-pills > li > a:hover", "color", _c);
                    } else if ($styleClick.hasClass("activt")) {
                        $headColorPickStyle.attr("data-2", _c);
                        writeStyle(styleName, _c,".nav-pills > li.active > a",".nav-pills li ul.dropdown-menu li a:focus");
        ...
        var initFontStyleEvent = function (selector,dataBox) {
            $(selector).bind("click",function(){
                ...
                if ($styleNormal.hasClass("activt")) {
                    ...
                    dataBox.attr("data-0", txt);
                    writeStyle(_style, txt,".nav-pills > li:not(.active):not(:hover) > a",".nav-pills li ul.dropdown-menu li a:not(:hover)");
                   // changeMainStyle(".nav-pills > li:not(.active):not(:hover) > a", _style, txt);
                } else if ($styleHover.hasClass("activt")) {
                    var data="1";
                    var txt =setValue(_$this,_value,_reset,data);
                    dataBox.attr("data-1", txt);
                    writeStyle(_style, txt,".nav-pills > li > a:hover",".nav-pills li ul.dropdown-menu li a:hover");
                   // changeMainStyle(".nav-pills > li > a:hover", _style, txt);
                } else if ($styleClick.hasClass("activt")) {
                    var data="2";
                    var txt =setValue(_$this,_value,_reset,data);
                    dataBox.attr("data-2", txt);
                    writeStyle(_style, txt,".nav-pills > li.active > a",".nav-pills li ul.dropdown-menu li a:focus");
