...
WaterMark.prototype = {
    ...
    initUploadify: function(){
        var _this = this;
        var siteID = window.parent.parent.parent.headerinfo ? window.parent.parent.parent.headerinfo.siteID : window.parent.article.siteID;
        //上传按钮
        $("#uploadFile").uploadify({
            ...
            'width': 110,
            "method": "post",
            // 'swf': '../../../../xy/e5script/jquery/uploadify/uploadify.swf',
            // 'uploader': '../../../../xy/ueditor/uploadwatermark.do',
            'swf': '../../../../e5script/jquery/uploadify/uploadify.swf',
            'uploader': '../../../xy/ueditor/uploadwatermark.do?siteID='+siteID,
            'auto': true,
            "removeTimeout": 0,
            'fileObjName': 'file',
