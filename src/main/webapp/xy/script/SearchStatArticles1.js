e5.mod("workspace.search",function() {
	var api, searchparam,ready = false,
        ...
        _getSQLtime=function(ch){
            ...
            var BGTM=$("#exp_pubTime_from_emp").val();
            ...
            beginTime= beginTime=='' ? '1929-01-' + "01" + " 00:00:00" : beginTime;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (beginTime == '1929-01-01 00:00:00') {
