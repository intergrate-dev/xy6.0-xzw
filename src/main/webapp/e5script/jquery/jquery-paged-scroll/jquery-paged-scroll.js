    ...
    $.ajax_scroll.prototype = {
        ...
        _getScrollData:function ($, element, window, document, $this, settings) {
            var elemHeight = parseFloat($(element).height()) , elemScroll = parseFloat($(element).scrollTop()),
                ...
                var scrollDis = ($(element)[0].scrollHeight-$(element)[0].clientHeight)-elemScroll;
            return {elemHeight:elemHeight, elemScroll:elemScroll, isWindow:isWindow, docHeight:docHeight, step:step,frombottom:$this._calculateStep(settings),scrollDis:scrollDis};
        },
        ...
        */
        _checkScroll:function (element, $, window, document, settings) {
            ...
            */
            ...
            var frombottom = scrollData.frombottom;
            var scrollDis = scrollData.scrollDis;
            ...
            var isPos = true;// (position > $this.lastScrollPosition);
            /*
