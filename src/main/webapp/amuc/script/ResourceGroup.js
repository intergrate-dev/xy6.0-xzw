...
e5.mod("workspace.resourcetree", function() {
	...
	var submitNewGroup = function() {
		...
		$.ajax({
			async: false,
			url : "../amuc/common/group/addGroupAjax.do",
			type : 'POST',
			data : {
	...
	var submitModifiedGroup = function() {
		...
		$.ajax({
			async: false,
			url : "../amuc/common/group/modifyGroupAjax.do",
			type : 'POST',
			data : {
				"categoryTypeId" : main_param.catTypeID,
				"siteID" : main_param.siteID,
	...
	var groupDelete = function() {
		...
		$.ajax({
			async: false,
			url : "../amuc/common/group/deleteGroupAjax.do",
			type : 'POST',
			data : {
				"categoryTypeId" : main_param.catTypeID,
				"siteID" : main_param.siteID,
	...
	var doDeleteGroup = function(data){
		...
		if(!confirm(data.message)){
			...
			$.ajax({
				async: false,
				url : "../amuc/common/group/doDeleteGroupAjax.do",
				type : 'POST',
				data : {
					"categoryTypeId" : main_param.catTypeID,
					"siteID" : main_param.siteID,
