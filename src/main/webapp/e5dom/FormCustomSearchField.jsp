...
<html>
	<head>
		...
		<script type="text/javascript" src="script/searchForm.js"></script>
		<script type="text/javascript">
			var i18n = {
				...
				help1:"<i18n:message key="e5dom.search.help1"/>",
				help2:"<i18n:message key="e5dom.search.help2"/>",
				help3:"<i18n:message key="e5dom.search.help3"/>",
	...
	<body>
		<div class="field-container">
			<div class="menu">
				<h2><i18n:message key="e5dom.search.tabletitle"/></h2>
				<div class="content">
					<i18n:message key="e5dom.search.title"/>:<span id="txtFormName"></span><i18n:message key="e5dom.search.code"/>:<span id="txtFormCode"></span>
				</div>
			</div>
			<div class="mainContent">
				<div class="sidebar">
					<h2>
						<i18n:message key="e5dom.custom.form.editor.fields"/>						
					</h2>
					<div class="docType docType-field"><select id="sl-doc-type" style="margin-top:5px;margin-left:10px;width:130px;height:25px;"></select></div>
					<div class="search-field"><input id="txt-field-search" type="text" /></div>
					<ul id="listfield" class="field-list clearfix">
					</ul>
					<ul id="listCust" style="display:none"  class="field-list-cust clearfix">
						...
						<li style="display:none" class="drop-class btn-icon" fieldtype="-2" fieldcode="insertsavesubmit"><i18n:message key="e5dom.form.custom.btnsavesubmit"/></li>
				...
				<div class="workspace">
					<h2><i18n:message key="e5dom.custom.form.editor.fieldedit"/><span class="formfieldtooltip"><i18n:message key="e5dom.search.help3"/></span></h2>
					
					<div class="content" id="tablecontent">
						<div id="tableContainer" >
							<ul id="list_common" class="list_search" title="<i18n:message key="e5dom.search.help1"/>"></ul>
							<ul id="list_more" class="list_search" title="<i18n:message key="e5dom.search.help2"/>"></ul>
						</div>
					</div>
				</div>
			</div>
