...
<head>
	...
	<script type="text/javascript">
		var headerinfo = {
			...
			errordynamiccode : "<i18n:message key="workspace.login.errordynamiccode"/>",
			nodynamiccode : "<i18n:message key="workspace.login.nodynamiccode"/>"
		}
	</script>
	<!--[if IE]>
		<style type="text/css">
		...
		<form action="" method="post">
			<ul>
				...
				<li  class="dynamic_class" style="display:none;">
					<img class="icon app05 DynamicCodeImg" src="../images/menu/004.png" alt="" />
					<input class="user code" type="text" id="DynamicCode" name="DynamicCode"
					required="required" placeholder="<i18n:message key="workspace.login.dynamiccode"/>" />
				</li>
			</ul>
			<div class="keep">
			</div>
