...
@Component
public class ArticleStatisticsBySource implements IStatistics {
    @Autowired
    ...
    public Map<String, Object> statistics(Map<String, Object> inParam) throws E5Exception {
        ...
        String sourceName = MapUtils.getString(inParam,"particularParam");
        Timestamp beginTime;
        Timestamp endTime;
        try{
        ...
        log.error("---快闪开，ArticleRankingBySource.java要开始统计了---");
        List<Map<String, Object>> statisticsDataList = statisticsDAO.getTotalArticleStatisticsOfTimeBySourceName(siteID, sourceName, tableName, beginTime, endTime, pageSize, pageNum);
        Map<String, Object> returnMap = new HashMap<>();
        returnMap.put("statisticsData", statisticsDataList);
        returnMap.put("viewName", "xy/statistics/ArticleOverviewStatisticsBySource");
        int totalCount = statisticsDAO.countTotalArticleStatisticsOfTimeBySourceName(siteID, sourceName, tableName, beginTime, endTime);
